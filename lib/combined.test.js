...
describe('Sort and align combined', () => {
    ...
    it('should sort and align imports', () => {
        const code = `
import { Action, State } from 'common/api/exportImport/importContext';
import { expect } from 'chai';
let d;`

        const messages = createLinter().verifyAndFix(code, {
            parser: 'BabelParser',
            rules: {
                AlignImports: /*[*/1/*, 45]*/,
...
// ruleTester.run('SortImportsAndAlign', rule, {
//     valid: [
...
// import { expect } from 'chai';
// let d;`,
//             errors: [{ message: 'Imports not aligned correctly', line: 2, }, { message: 'Imports not sorted correctly', line: 2, }],
//             options,
//             output:
//                 `
// import { expect } from 'chai';
